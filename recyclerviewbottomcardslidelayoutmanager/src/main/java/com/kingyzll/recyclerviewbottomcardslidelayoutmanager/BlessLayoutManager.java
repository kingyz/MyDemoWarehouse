 ...
 */
public class BlessLayoutManager extends RecyclerView.LayoutManager {
    ...
    public BlessLayoutManager() {
        this(new Builder());
    }

    private BlessLayoutManager(Builder builder) {
...
// onceCompleteScrollLength) / (onceCompleteScrollLength * 1.0f));
    ...
    public static class Builder {
        ...
        public BlessLayoutManager build() {
            return new BlessLayoutManager(this);
        }
    }
    ...
    public interface TrasitionListener {
         ...
         */
        void handleLayerView(BlessLayoutManager focusLayoutManager, View view, int viewLayer,
         ...
         * @param offset             当次滑动偏移量
         */
        void handleFocusingView(BlessLayoutManager focusLayoutManager, View view, int position,
         ...
         * @param offset             当次滑动偏移量
         */
        void handleNormalView(BlessLayoutManager focusLayoutManager, View view, int position,
                              float fraction, float offset);
    ...
    public static class TrasitionListenerConvert implements TrasitionListener {
        ...
        @Override
        public void handleLayerView(BlessLayoutManager focusLayoutManager, View view,
...
//            log("layer =" + viewLayer + ";alpha = " + realAlpha + ";fraction = " + fraction);
        ...
        @Override
        public void handleFocusingView(BlessLayoutManager focusLayoutManager, View view,
        ...
        @Override
        public void handleNormalView(BlessLayoutManager focusLayoutManager, View view,
                                     int position, float fraction, float offset) {
            /**
             * 期望效果：直接完成变换
             */
